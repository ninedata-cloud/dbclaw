...
def test_normalize_skill_authorizations_defaults_to_all_disabled():
    ...
    assert normalized["knowledge_retrieval"] is False
...
def test_skill_authorization_catalog_marks_groups_disabled_by_default():
    ...
    assert enabled_by_default["knowledge_retrieval"] is False
