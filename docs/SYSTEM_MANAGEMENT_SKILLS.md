...
SmartDBA provides 7 system management skills that enable AI-driven management of system resources through natural language. These skills are designed for AI conversation use only.
