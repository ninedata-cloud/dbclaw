...
TARGET_COLUMNS: dict[str, tuple[str, ...]] = {
    "alert_delivery_log": ("id",),
    "integration_execution_log": ("id",),
}
...
async def migrate() -> None:
    async with async_session() as db:
        ...
        await db.commit()
        logger.info("Log-table bigint migration completed: changed=%s skipped=%s", changed, skipped)
