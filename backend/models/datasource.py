...
class Datasource(SoftDeleteMixin, Base):
    ...
    db_type = Column(String(20), nullable=False)  # mysql, postgresql, sqlserver, oracle, tdsql-c-mysql, oceanbase-mysql, opengauss, hana
    ...
    extra_params = Column(JSONB, nullable=True)  # Structured connection-specific params
    ...
    inbound_source = Column(JSONB, nullable=True)  # integration binding + params
