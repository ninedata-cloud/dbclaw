from sqlalchemy import BigInteger, Column, Integer, Numeric, DateTime, Index, PrimaryKeyConstraint
...
class HostMetric(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("id", "collected_at", name="host_metric_pkey"),
    ...
    data = Column(JSONB, nullable=True)  # 完整 OS 指标 JSON（含磁盘IO、网络IO、负载等）
