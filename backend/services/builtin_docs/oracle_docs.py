...
-- 或添加新数据文件
ALTER TABLESPACE users ADD DATAFILE '/path/new.dbf' SIZE 5G AUTOEXTEND ON;
```
...
-- 扩展表空间
ALTER TABLESPACE users ADD DATAFILE '/u01/users02.dbf' SIZE 5G AUTOEXTEND ON;
-- 或扩展现有数据文件
ALTER DATABASE DATAFILE '/u01/users01.dbf' RESIZE 20G;
```
